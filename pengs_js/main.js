...
(() => {
    ...
    n.n = t => {
        ...
        var t = {
                386: (t, e, n) => {
                    ...
                    class y extends a {
                        ...
                        getSpan(t, e = 0) {
                            ...
                            let n = 0,
                                r = this.count;
                            if (r instanceof s && (r = r.decode(t, e)), 0 < this.elementLayout.span) n = r * this.elementLayout.span;
                            else {
                                let i = 0;
                    ...
                    class m extends a {
                        ...
                        decode(t, e = 0) {
                            ...
                            for (const r of this.fields)
                                if (void 0 !== r.property && (n[r.property] = r.decode(t, e)), e += r.getSpan(t, e), this.decodePrefixes && t.length === e) break;
                            return n
                        }
                        encode(t, e, n = 0) {
                            const r = n;
                    ...
                    t.exports = function(t) {
                        ...
                        function l(t) {
                            ...
                            for (var a = (t.length - n) * c + 1 >>> 0, f = new Uint8Array(a); t[n];) {
                                ...
                                if (255 === l) return;
                                for (var h = 0, d = a - 1;
                                    (0 !== l || h < o) && -1 !== d; d--, h++) l += s * f[d] >>> 0, f[d] = l % 256 >>> 0, l = l / 256 >>> 0;
                            ...
                            encode: function(e) {
                                ...
                                for (var c = (a - o) * f + 1 >>> 0, l = new Uint8Array(c); o !== a;) {
                                    for (var h = e[o], d = 0, p = c - 1;
                                        (0 !== h || d < i) && -1 !== p; p--, d++) h += 256 * l[p] >>> 0, l[p] = h % s >>> 0, h = h / s >>> 0;
                    ...
                    e.oU = function(t) {
                    ...
                    }, e.k$ = function(t, e) {
                        {
                            const n = t.toString(16),
                                r = Buffer.from(n.padStart(2 * e, "0").slice(0, 2 * e), "hex");
                            return r.reverse(), r
                        }
                    }
                },
                    ...
                    ! function(t, e) {
                        ...
                        if (o.isBN = function(t) {
                                ...
                                var i, o = 0,
                                    a = 0;
                                if ("be" === n)
                                    for (r = t.length - 1; r >= e; r -= 2) i = u(t, e, r) << o, this.words[a] |= 67108863 & i, o >= 18 ? (o -= 18, a += 1, this.words[a] |= i >>> 26) : o += 8;
                                else
                                    for (r = (t.length - e) % 2 == 0 ? e + 1 : e; r < t.length; r += 2) i = u(t, e, r) << o, this.words[a] |= 67108863 & i, o >= 18 ? (o -= 18, a += 1, this.words[a] |= i >>> 26) : o += 8;
                                this._strip()
                        ...
                        Math.imul || (y = g), o.prototype.mulTo = function(t, e) {
                            ...
                            for (var f = n.clone(), l = e.clone(); !e.isZero();) {
                                ...
                                if (h > 0)
                                    for (e.iushrn(h); h-- > 0;)(i.isOdd() || a.isOdd()) && (i.iadd(f), a.isub(l)), i.iushrn(1), a.iushrn(1);
                ...
                764: (t, e, n) => {
                    ...
                    e.kMaxLength = a, u.TYPED_ARRAY_SUPPORT = function() {
                        ...
                        for (n = 0; n < t.length; ++n) {
                            let e = t[n];
                            if (Z(e, Uint8Array)) i + e.length > r.length ? (u.isBuffer(e) || (e = u.from(e)), e.copy(r, i)) : Uint8Array.prototype.set.call(r, e, i);
                            else {
                ...
                652: function() {
                    ! function(t) {
                        ...
                        function x(t, e, n, r) {
                            ...
                            for (var i in t.$ < 0 && (t = qe(t), e = qe(e)), t)
                                if (!x(t[i], e[i], n + 1, r)) return !1;
                            return !0
                        }
                        n((function(t, e) {
                        ...
                        var D = n((function(t, e) {
                            ...
                            H = (n((function(t, e) {
                                ...
                                if (n < 1) return _;
                                for (var r = 0, i = [];
                                    (r = e.indexOf(t, r)) > -1;) i.push(r), r += n;
                                return P(i)
                            })));
                                ...
                                case 1:
                                    ...
                                    return void(n[i] = function(t, e, n) {
                                        return n = n || {
                                            i: _,
                                            j: _
                                        }, t ? n.i = T(e, n.i) : n.j = T(e, n.j), n
                                    }(t, o, n[i]));
                                case 2:
                                    for (var a = e.m; a.b; a = a.b) jt(t, a.a, n, r);
                                    return;
                                case 3:
                                    return void jt(t, e.o, n, {
                                        s: e.n,
                                        t: r
                                    })
                            }
                        ...
                        function zt(t) {
                            ...
                            return It[t].b = i, It[t].c = r((function(t, r, o) {
                                for (; r.b; r = r.b)
                                    for (var a = e, s = n(r.a), u = 0; u < a.length; u++) a[u](s);
                                return i
                            })), {
                        ...
                        i((function(t, e, n, r) {
                            var i = r.node;
                            return i.parentNode.replaceChild(fe(t, (function() {})), i), {}
                        }));
                        ...
                        var ie, oe = n((function(t, e) {
                                return "a0" === e.$ ? f(Xt, e.n, function(t, e) {
                                    ...
                                    return {
                                        $: e.$,
                                        a: n ? l(Fn, n < 3 ? ae : se, Hn(t), e.a) : f(Dn, t, e.a)
                                    }
                                }(t, e.o)) : e
                            })),
                            ae = n((function(t, e) {
                        ...
                        function ge(t, e, n) {
                            ...
                            for (var i in n) {
                                ...
                                if (o) {
                                    ...
                                    a = ye(e, o), t.addEventListener(i, a, ie && {
                                        passive: Vn(o) < 2
                                    }), r[i] = a
                            ...
                            function n(e) {
                                ...
                                if (qn(i)) {
                                    for (var o, a = Vn(r), s = i.a, u = a ? a < 3 ? s.a : s.F : s, c = 1 == a ? s.b : 3 == a && s.aN, f = (c && e.stopPropagation(), (2 == a ? s.b : 3 == a && s.aI) && e.preventDefault(), t); o = f.j;) {
                                        if ("function" == typeof o) u = o(u);
                                        else
                                            for (var l = o.length; l--;) u = o[l](u);
                                        f = f.p
                                    }
                                    f(u, c)
                                }
                        ...
                        function Ae(t, e, n, r) {
                            for (var i = [], o = {}, a = [], s = t.e, u = e.e, c = s.length, f = u.length, l = 0, h = 0, d = r; l < c && h < f;) {
                                ...
                                if (y !== m) {
                                    ...
                                    if (w && x) we(v, B, i, ++d), Ie(o, i, y, b, h, a), d += v.b || 0, Be(o, i, y, S, ++d), d += S.b || 0, l += 2, h += 2;
                                    else if (w) d++, Ie(o, i, m, b, h, a), we(v, B, i, d), d += v.b || 0, l += 1, h += 2;
                                    else if (x) Be(o, i, y, v, ++d), d += v.b || 0, we(S, b, i, ++d), d += S.b || 0, l += 2, h += 1;
                                    else {
                                        if (!k || A !== I) break;
                            ...
                            }(i.length > 0 || a.length > 0 || M) && be(n, 8, r, {
                                w: i,
                                x: a,
                                y: M
                            })
                        ...
                        function Ie(t, e, n, r, i, o) {
                            ...
                            if (1 === a.c) {
                                ...
                                var s = [];
                                return we(a.z, r, s, a.r), a.r = i, void(a.s.s = {
                                    w: s,
                                    A: a
                                })
                            }
                        ...
                        function Be(t, e, n, r, i) {
                            ...
                            if (o) {
                                if (0 === o.c) {
                                    o.c = 2;
                                    var a = [];
                                    return we(r, o.z, a, i), void be(e, 9, i, {
                                        w: a,
                                        A: o
                                    })
                                }
                        ...
                        function Oe(t, e, n, r, i, o, a) {
                            for (var s = n[r], u = s.r; u === i;) {
                                var c = s.$;
                                if (1 === c) Me(t, e.k, s.s, a);
                                else if (8 === c) s.t = t, s.u = a, (f = s.s.w).length > 0 && Oe(t, e, f, 0, i, o, a);
                                else if (9 === c) {
                                    s.t = t, s.u = a;
                                    var f, l = s.s;
                        ...
                        r((function(t, e, n) {
                            return vt(pt((function(r) {
                                ...
                                return t.addEventListener(e, i, ie && {
                                        passive: !0
                                    }),
                                    function() {
                                ...
                                t: for (;;) switch (t.$) {
                                    case 0:
                                        var n = t.a,
                                            r = t.b,
                                            i = function() {
                                                var t, e, r = (e = (t = n).charCodeAt(0), isNaN(e) ? Qe : Xe(55296 <= e && e <= 56319 ? I(t[0] + t[1], t.slice(2)) : I(t[0], t.slice(1))));
                                                if (1 === r.$) return !1;
                                                var i = r.a,
                                                    o = i.a,
                                                    a = i.b;
                        ...
                        var wr, xr, kr, Er, Ar, Sr, Ir, Br = Ot("Task"),
                            Mr = n((function(t, e) {
                                return Br(f(dr, t, e))
                            })),
                            Or = $e,
                            ...
                            Wr = G,
                            qr = Nt("connectCb", (Ir = P([Nr(Qe), f(Dn, Xe, Wr)]), {
                                $: 11,
                                g: Ir
                            })),
                            Kr = Nt("disconnectIn", Nr(0)),
                            Dr = Nt("walletCb", f(Kn, (function(t) {
                                        ...
                                        switch (t.$) {
                                            ...
                                            case 5:
                                                var c = t.a,
                                                    l = t.b;
                                                return M(e, {
                                                    i: f(ze, f(ya, f(ga, r.v + " + " + c, ""), l), e.i)
                                                });
                                            case 1:
                                                var h = t.a,
                                                    d = t.b;
                                                return M(e, {
                                                    i: f(ze, f(ya, f(ga, r.v + " > " + h, ""), d), e.i)
                                                });
                                            case 2:
                                                return h = t.a, d = t.b, M(e, {
                                                    i: f(ze, f(ya, f(ga, r.v + " " + h, ""), d), e.i)
                                                });
                                            case 4:
                                                var p = t.a,
                                                    g = t.b;
                                                return M(e, {
                                                    i: f(ze, f(ya, f(ga, O(r.v, p), ""), g), e.i)
                                                });
                                            default:
                                                var y = t.a;
                                                return M(e, {
                                                    i: f(ze, f(ya, f(ga, r.v, ""), y), e.i)
                                                })
                                        }
                                    }));
                                return l(fr, i, r, e)
                                ...
                                switch (e.$) {
                                    ...
                                    case 8:
                                        var R = e.a,
                                            ...
                                            D = "grid-row-gap:" + z(R.c4.b) + ";",
                                            F = "grid-column-gap:" + z(R.c4.a) + ";",
                                            H = function(t) {
                            ...
                            za = function(t) {
                                var e = P([t.b8, t.bY, t.ci, t.cI]),
                                    n = f(oi, t.ci, Ua(e)),
                                    r = f(oi, t.bY, Ua(f(Ra, (function(t) {
                                        return !w(t, n)
                                    }), e))),
                                    i = f(oi, t.b8, function(t) {
                                        if (t.b) {
                                            var e = t.a,
                                                n = t.b;
                            ...
                            os = r((function(t, e, r) {
                                ...
                                if (1 === e.$) {
                                    ...
                                    if ((g = es(c) ? r.c9 : O(r.c9, c)).b) {
                                        var p = g;
                                        return io({
                                            cu: h(ts, r.N, r.O, r.J, no(l(so, "nearby-element-pls", u, r.K))),
                                            c9: p
                                        })
                                    }
                                ...
                                switch (t.$) {
                                    ...
                                    case 3:
                                        var o = t.a,
                                            a = t.b,
                                            s = "min-height-" + nn(o),
                                            u = l(as, s, "min-height", nn(o) + "px !important"),
                                            c = Ms(a),
                                            h = c.a,
                                            d = c.b,
                                            p = c.c;
                                ...
                                t: for (;;) {
                                    ...
                                    switch (h.$) {
                                        ...
                                        case 9:
                                            var N = h.a,
                                                W = h.b,
                                                q = (m = t, v = e, b = n, w = r, x = T = function() {
                                                    switch (W.$) {
                                                        case 3:
                                                            return i;
                                                        case 2:
                            ...
                            cu = Ji,
                            fu = cu(po("sc_hover_fade")),
                            lu = o((function(t, e, n, r, i) {
                                return {
                                    $: 7,
                                    a: t,
                                    b: e,
                            ...
                            Lu = ee("fill"),
                            Pu = Lu,
                            $u = Vt("http://www.w3.org/2000/svg"),
                            ju = $u("g"),
                            Cu = ee("height"),
                            Ru = $u("svg"),
                            Uu = ee("width"),
                            zu = i((function(t, e, n, r) {
                                var i = nn(n);
                            ...
                            gf = f(Gu, "animation", "rotation 0.7s infinite linear"),
                            yf = function(t) {
                            ...
                            xf = function(t) {
                                return l(ii, f(Ju, P([Ou]), yf(20)), (function(e) {
                                    return es(e) ? f(pf, P([lf]), P([xu("No Ethereum wallets have been detected. "), xu("You can learn more about installing one "), f(uf, "https://docs.solana.com/wallet-guide", f(Ju, P([rf]), xu("here"))), xu(".")])) : f(Hu, P([tf(20), Ds(Su)]), f(lr, (function(e) {
                                        return (w(t.ce, Qe) ? _u({
                                            $: 1,
                                            a: e.cL
                                ...
                                init: Or({
                                    ...
                                    dw: function(t) {
                                        return l(mc, {
                                            ...
                                            var e, n, r, i, o, a
                                        }), t.dx), f(Ju, P([di, li]), f(uf, "https://github.com/ronanyeah/solana-connect/", f(Cc, P([tf(5)]), P([f(Ju, P([bu(15), rf]), xu("About Ethereum Connect")), f(ec, Lc, 17)]))))]))));
                                        var e, n
                                    }
                                })(f(Kn, (function(t) {
                                    return Hn({
                ...
                198: (t, e, n) => {
                    ...
                    t.exports = o, o.prototype.request = function(t, e, n, r) {
                        ...
                        if (s || !s && t && "object" == typeof t && "function" == typeof e) r = e, a = t;
                        else {
                ...
                379: (t, e) => {
                    ...
                    function u(t, e) {
                        ...
                        e = r(e), this._streaming = !1, this._BOMseen = !1, this._decoder = null, this._fatal = Boolean(e.fatal), this._ignoreBOM = Boolean(e.ignoreBOM), Object.defineProperty(this, "encoding", {
                            value: "utf-8"
                    ...
                    function c(t, e) {
                        ...
                        if ((t = void 0 !== t ? String(t).toLowerCase() : s) !== s) throw new Error("Encoding not supported. Only utf-8 is supported");
                        e = r(e), this._streaming = !1, this._encoder = null, this._options = {
                    ...
                    function f(t) {
                        ...
                        this.handler = function(t, f) {
                            ...
                            if (0 === s) {
                                ...
                                if (n(f, 194, 223)) s = 1, r = f - 192;
                                else if (n(f, 224, 239)) 224 === f && (u = 160), 237 === f && (c = 159), s = 2, r = f - 224;
                                else {
                    ...
                    u.prototype = {
                        decode: function(t, e) {
                            var n;
                            n = "object" == typeof t && t instanceof ArrayBuffer ? new Uint8Array(t) : "object" == typeof t && "buffer" in t && t.buffer instanceof ArrayBuffer ? new Uint8Array(t.buffer, t.byteOffset, t.byteLength) : new Uint8Array(0), e = r(e), this._streaming || (this._decoder = new f({
                                fatal: this._fatal
                        ...
                        encode: function(t, e) {
                            ...
                            if (!this._streaming) {
                                for (;
                                    (n = this._encoder.handler(s, s.read())) !== o;) Array.isArray(n) ? a.push.apply(a, n) : a.push(n);
                                this._encoder = null
                            }
        ...
        (() => {
            ...
            t = new WeakMap;
            const h = "solana:signAndSendTransaction",
                d = "solana:signTransaction",
                p = "standard:connect",
                g = "standard:events";
            var y, m = r(729);
            ...
            const F = {
                ...
                H = F,
                V = "object" == typeof globalThis && "crypto" in globalThis ? globalThis.crypto : void 0,
                J = t => t instanceof Uint8Array,
                Z = t => new DataView(t.buffer, t.byteOffset, t.byteLength),
                G = (t, e) => t << 32 - e | t >>> e;
            ...
            class rt extends tt {
                ...
                update(t) {
                    ...
                    for (let o = 0; o < i;) {
                        ...
                        if (a !== r) n.set(t.subarray(o, o + a), this.pos), this.pos += a, o += a, this.pos === r && (this.process(e, 0), this.pos = 0);
                        else {
                            const e = Z(t);
            ...
            const st = function(t, e = !1) {
                ...
                ft = (t, e, n) => t >>> n | e << 32 - n,
                lt = (t, e, n) => t << 32 - n | e >>> n,
                ht = (t, e, n) => t << 64 - n | e >>> n - 32,
                dt = (t, e, n) => t >>> n - 32 | e << 64 - n,
                pt = function(t, e, n, r) {
                    const i = (e >>> 0) + (r >>> 0);
                    return {
                        h: t + n + (i / 2 ** 32 | 0) | 0,
            ...
            class St extends rt {
                ...
                process(t, e) {
                    ...
                    for (let t = 16; t < 80; t++) {
                        const e = 0 | Et[t - 15],
                            n = 0 | At[t - 15],
                            r = ft(e, n, 1) ^ ft(e, n, 8) ^ ut(e, 0, 7),
                            i = lt(e, n, 1) ^ lt(e, n, 8) ^ ct(e, n, 7),
                            o = 0 | Et[t - 2],
                            a = 0 | At[t - 2],
                            s = ft(o, a, 19) ^ ht(o, a, 61) ^ ut(o, 0, 6),
                            u = lt(o, a, 19) ^ dt(o, a, 61) ^ ct(o, a, 6),
                            c = mt(i, u, At[t - 7], At[t - 16]),
                    ...
                    for (let t = 0; t < 80; t++) {
                        const e = ft(f, l, 14) ^ ft(f, l, 18) ^ ht(f, l, 41),
                            v = lt(f, l, 14) ^ lt(f, l, 18) ^ dt(f, l, 41),
                            b = f & h ^ ~f & p,
                            w = wt(m, v, l & d ^ ~l & g, kt[t], At[t]),
                            x = bt(w, y, e, b, xt[t], Et[t]),
                            k = 0 | w,
                        ...
                        h: n,
                        l: r
                    } = pt(0 | this.Ah, 0 | this.Al, 0 | n, 0 | r)), ({
                        h: i,
                        l: o
            ...
            const Ot = et((() => new St)),
                _t = (et((() => new It)), et((() => new Bt)), et((() => new Mt)), BigInt(0), BigInt(1)),
                Tt = BigInt(2),
            ...
            const Kt = t => (Tt << BigInt(t - 1)) - _t,
                Dt = t => new Uint8Array(t),
                Ft = t => Uint8Array.from(t);
                    ...
                    s = Object.freeze({
                        ...
                        invertBatch: t => function(t, e) {
                            const n = new Array(e.length),
                                r = e.reduce(((e, r, i) => t.is0(r) ? e : (n[i] = e, t.mul(e, r))), t.ONE),
                                i = t.inv(r);
            ...
            function ve(t) {
                ...
                class x {
                    ...
                    assertValidity() {
                        ...
                        const {
                            ...
                            ez: o,
                            et: a
                        } = this, s = f(r * r), u = f(i * i), c = f(o * o), l = f(c * c), h = f(s * t);
                    ...
                    equals(t) {
                        ...
                        const {
                            ...
                            ey: o,
                            ez: a
                        } = t, s = f(e * a), u = f(i * r), c = f(n * a), l = f(o * r);
                        return s === u && c === l
                    }
                    is0() {
                    ...
                    double() {
                        const {
                            ...
                            ey: r,
                            ez: i
                        } = this, o = f(n * n), a = f(r * r), s = f(ge * f(i * i)), u = f(t * o), c = n + r, l = f(f(c * c) - o - a), h = u + a, d = h - s, p = u - a, g = f(l * d), y = f(h * p), m = f(l * p), v = f(d * h);
                    ...
                    static fromHex(t, r = !1) {
                        const {
                            d: i,
                            a: o
                        } = e, a = n.BYTES, s = (t = Wt("pointHex", t, a)).slice(), u = t[a - 1];
                        s[a - 1] = -129 & u;
                        const h = Ut(s);
                ...
                function B(t) {
                    ...
                    const n = Wt("hashed private key", o(t), 2 * e),
                        r = h(n.slice(0, e)),
                        i = n.slice(e, 2 * e),
                        a = I(r),
                        u = k.multiply(a),
                ...
                return k._setWindowSize(8), {
                    ...
                    sign: function(t, e, r = {}) {
                        ...
                        const {
                            ...
                            scalar: a,
                            pointBytes: u
                        } = B(e), c = M(r.context, o, t), f = k.multiply(c).toRawBytes(), l = S(c + M(r.context, f, u, t) * a);
            ...
            Me.pow(ke, Le), Me.sqrt(Me.neg(Me.ONE)), Me.ORDER, BigInt(5), BigInt(8), BigInt(486662),
                function(t, e) {
            ...
            function* hn(t, e, n = {}) {
                ...
                if (o && (t = e.coercer(t, s), a && "type" !== e.type && un(e.schema) && un(t) && !Array.isArray(t)))
                ...
                if (u)
                    for (const n of e.refiner(t, s)) u = !1, yield [n, void 0];
                u && (yield [void 0, t])
            }
            class dn {
                constructor(t) {
            ...
            const [$n, jn, Cn] = [
                ...
                [],
                []
            ], Rn = BigInt(0), Un = BigInt(1), zn = BigInt(2), Nn = BigInt(7), Wn = BigInt(256), qn = BigInt(113);
            ...
            const [Kn, Dn] = st(Cn, !0), Fn = (t, e, n) => n > 32 ? ((t, e, n) => e << n - 32 | t >>> 64 - n)(t, e, n) : ((t, e, n) => t << n | e >>> 32 - n)(t, e, n), Hn = (t, e, n) => n > 32 ? ((t, e, n) => t << n - 32 | e >>> 64 - n)(t, e, n) : ((t, e, n) => e << n | t >>> 32 - n)(t, e, n);
            class Vn extends tt {
            ...
            const Jn = (t, e, n) => et((() => new Vn(e, t, n))),
                ...
                Gn = (Jn(1, 104, 48), Jn(1, 72, 64), (t, e, n) => function(t) {
                    const e = (e, n) => t(n).update(X(e)).digest(),
                        n = t({});
                    ...
                    const n = e => function(t) {
                            ...
                            class l {
                                ...
                                equals(t) {
                                    ...
                                    const {
                                        ...
                                        py: a,
                                        pz: s
                                    } = t, u = n.eql(n.mul(e, s), n.mul(o, i)), c = n.eql(n.mul(r, s), n.mul(a, i));
                                    return u && c
                                }
                                negate() {
                                ...
                                multiplyUnsafe(t) {
                                    ...
                                    let {
                                        ...
                                        k2neg: u,
                                        k2: c
                                    } = i.splitScalar(t), f = r, h = r, p = this;
                        ...
                        class g {
                            ...
                            recoverPublicKey(t) {
                                ...
                                const l = 1 & o ? "03" : "02",
                                    ...
                                    g = a(-c * p),
                                    y = a(i * p),
                                    m = u.BASE.multiplyAndAddUnsafe(d, g, y);
                        ...
                        const y = {
                            ...
                            randomPrivateKey: () => zt(function(t, e, n = !1) {
                                const r = (t = Wt("privateHash", t)).length,
                                    i = se(e).nByteLength + 8;
                        ...
                        return u.BASE._setWindowSize(8), {
                            ...
                            verify: function(t, n, r, i = E) {
                                ...
                                const {
                                    r: d,
                                    s: p
                                } = l, y = b(n), m = s(p), v = a(y * m), w = a(d * m), x = u.BASE.multiplyAndAddUnsafe(h, v, w)?.toAffine();
                                return !!x && a(x.x) === d
                            },
                            ProjectivePoint: u,
                            Signature: g,
            ...
            var dr = function() {
                    var t = _e.utils.randomPrivateKey(),
                        e = pr(t),
                        n = new Uint8Array(64);
            ...
            var Ar = function(t) {
                ...
                return W(s, [{
                    ...
                    key: "createWithSeed",
                    value: (r = $e(Ne().mark((function t(e, n, r) {
                        var i, o;
                    ...
                    value: (n = $e(Ne().mark((function t(e, n) {
                        return Ne().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                    ...
                    value: (e = $e(Ne().mark((function t(e, n) {
                        return Ne().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
            ...
            var Mr = function(t) {
                ...
                function n(t, r) {
                    var i;
                    return R(this, n), (i = e.call(this, "Transaction was not confirmed in ".concat(r.toFixed(2), " seconds. It is ") + "unknown if it succeeded or failed. Check signature " + "".concat(t, " using the Ethereum Explorer or CLI tools."))).signature = void 0, i.signature = t, i
                }
                return W(n)
            }(Pn(Error));
                        ...
                        value: function(t) {
                            ...
                            return t.map((function(t) {
                                return {
                                    ...
                                    accountKeyIndexes: t.keys.map((function(t) {
                                        return n(t.pubkey)
                                    })),
                                    data: t.data
                                }
            ...
            var Wr = function() {
                ...
                qr = function() {
                    ...
                    return W(t, [{
                        ...
                        key: "serialize",
                        value: function() {
                            var t = this.accountKeys.length,
                                e = [];
                            Rr(e, t);
                            var n = this.instructions.map((function(t) {
                                    var e = t.accounts,
                                        n = t.programIdIndex,
                                        r = Array.from(De().decode(t.data)),
                                        i = [];
                                    Rr(i, e.length);
                                    var o = [];
                        ...
                        key: "compile",
                        value: function(e) {
                            var n = nn(Wr.compile(e.instructions, e.payerKey).getMessageComponents(), 2),
                                r = n[0],
                                i = n[1],
                                o = new Tr(i).compileInstructions(e.instructions).map((function(t) {
                                    return {
                                        programIdIndex: t.programIdIndex,
                        ...
                        value: function(e) {
                            ...
                            return new t({
                                ...
                                recentBlockhash: De().encode(q.Buffer.from(f)),
                                accountKeys: s,
                                instructions: h
                            })
                        }
            ...
            var Fr = function() {
                    ...
                    return W(t, [{
                        ...
                        value: function() {
                            ...
                            var e = this.serializeInstructions(),
                                n = Array();
                            Rr(n, this.compiledInstructions.length);
                            var r = this.serializeAddressTableLookups(),
                                i = Array();
                        ...
                        value: function() {
                            var t, e = 0,
                                n = new Uint8Array(Sr),
                                r = Kr(this.compiledInstructions);
                            try {
                                for (r.s(); !(t = r.n()).done;) {
                                    var i = t.value,
                                        o = Array();
                        ...
                        key: "compile",
                        value: function(e) {
                            var n, r = Wr.compile(e.instructions, e.payerKey),
                                i = new Array,
                                o = {
                                    writable: new Array,
                                    readonly: new Array
                                },
                                a = Kr(e.addressLookupTableAccounts || []);
                            try {
                                for (a.s(); !(n = a.n()).done;) {
                                    var s = n.value,
                                        u = r.extractTableLookup(s);
                                    if (void 0 !== u) {
                                        var c, f, l = nn(u, 2),
                                            h = l[0],
                                            d = l[1],
                            ...
                            var y = nn(r.getMessageComponents(), 2),
                                m = y[0],
                                v = y[1],
            ...
            var Gr = q.Buffer.alloc(64).fill(0),
                Yr = function() {
                    function t(e) {
                ...
                Xr = function() {
                    function t(e) {
                        if (R(this, t), this.signatures = [], this.feePayer = void 0, this.instructions = [], this.recentBlockhash = void 0, this.lastValidBlockHeight = void 0, this.nonceInfo = void 0, this.minNonceContextSlot = void 0, this._message = void 0, this._json = void 0, e)
                    ...
                    return W(t, [{
                        ...
                        value: function() {
                            ...
                            if (e.length < 1 && console.warn("No instructions provided"), this.feePayer) n = this.feePayer;
                            else {
                            ...
                            for (var r = 0; r < e.length; r++)
                                if (void 0 === e[r].programId) throw new Error("Transaction instruction index ".concat(r, " has undefined program id"));
                            var i = [],
                                o = [];
                            ...
                            var m = g.concat(y),
                                v = e.map((function(t) {
                                    ...
                                    return {
                                        ...
                                        accounts: t.keys.map((function(t) {
                        ...
                        key: "getEstimatedFee",
                        value: (e = $e(Ne().mark((function t(e) {
                            return Ne().wrap((function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                        ...
                        value: function(t) {
                            var e = Object.assign({
                                ...
                                n = e.requireAllSignatures,
                                r = e.verifySignatures,
                        ...
                        key: "_serialize",
                        value: function(t) {
                            var e = this.signatures,
                                n = [];
                            Rr(n, e.length);
                            var r = n.length + 64 * e.length + t.length,
                                i = q.Buffer.alloc(r);
                        ...
                        value: function(e) {
                            ...
                            return r.recentBlockhash = e.recentBlockhash, e.header.numRequiredSignatures > 0 && (r.feePayer = e.accountKeys[0]), n.forEach((function(t, n) {
                                ...
                                var n = t.accounts.map((function(t) {
                                    ...
                                    return {
                                        pubkey: n,
                                        isSigner: r.signatures.some((function(t) {
            ...
            var ti = function() {
                    function t(e, n) {
                        if (R(this, t), this.signatures = void 0, this.message = void 0, void 0 !== n) Ur(n.length === e.header.numRequiredSignatures, "Expected signatures length to be equal to the number of required signatures"), this.signatures = n;
                        else {
            ...
            function ui(t, e) {
                var n = t.layout.span >= 0 ? t.layout.span : jr(t, e),
                    r = q.Buffer.alloc(n),
                    i = Object.assign({
                        instruction: t.index
                    }, e);
            ...
            var ci = Qe._O("lamportsPerSignature"),
                ...
                hi = Object.freeze({
                    ...
                    Assign: {
                        index: 1,
                        layout: Qe.n_([Qe.Jq("instruction"), Lr("programId")])
                    },
                    Transfer: {
                        index: 2,
                        layout: Qe.n_([Qe.Jq("instruction"), li("lamports")])
                    },
                    CreateWithSeed: {
                        index: 3,
                    ...
                    AdvanceNonceAccount: {
                        index: 4,
                        layout: Qe.n_([Qe.Jq("instruction")])
                    },
                    WithdrawNonceAccount: {
                        index: 5,
                        layout: Qe.n_([Qe.Jq("instruction"), Qe.gM("lamports")])
                    },
                    InitializeNonceAccount: {
                        index: 6,
                        layout: Qe.n_([Qe.Jq("instruction"), Lr("authorized")])
                    },
                    ...
                    Allocate: {
                        index: 8,
                        layout: Qe.n_([Qe.Jq("instruction"), Qe.gM("space")])
                    },
                    AllocateWithSeed: {
                        index: 9,
                ...
                di = function() {
                    ...
                    return W(t, null, [{
                        ...
                        key: "nonceInitialize",
                        value: function(t) {
                            var e = ui(hi.InitializeNonceAccount, {
                        ...
                        key: "nonceAdvance",
                        value: function(t) {
                            var e = ui(hi.AdvanceNonceAccount),
                                n = {
                                    keys: [{
                                        pubkey: t.noncePubkey,
                                        isSigner: !1,
                        ...
                        key: "nonceWithdraw",
                        value: function(t) {
                            var e = ui(hi.WithdrawNonceAccount, {
                                lamports: t.lamports
                            });
                            return new Yr({
                                keys: [{
                        ...
                        key: "nonceAuthorize",
                        value: function(t) {
                            var e = ui(hi.AuthorizeNonceAccount, {
            ...
            var pi = function() {
                ...
                return W(t, null, [{
                    ...
                    key: "load",
                    value: (e = $e(Ne().mark((function e(n, r, i, o, a) {
                            ...
                            for (;;) switch (e.prev = e.next) {
                                ...
                                case 25:
                                    ...
                                    if (g = d.slice(0, l), y = q.Buffer.alloc(l + 16), f.encode({
                                            ...
                                            commitment: "confirmed"
                                        })), !n._rpcEndpoint.includes("solana.com")) {
                                        e.next = 35;
                                        break
                                    }
                                ...
                                case 41:
                                    return v = Qe.n_([Qe.Jq("instruction")]), b = q.Buffer.alloc(v.span), v.encode({
                                        instruction: 1
                                    }, b), w = (new Xr).add({
                                        keys: [{
                                            pubkey: i.publicKey,
                                        ...
                                        programId: o,
                                        data: b
                                    }), x = "processed", e.next = 48, n.sendTransaction(w, [r, i], {
                                        preflightCommitment: x
                                    });
                                case 48:
                                ...
                                case 56:
                                    return e.prev = 57, e.next = 60, n.getSlot({
                                        commitment: x
                                    });
                                case 60:
                                    if (!(e.sent > A.slot)) {
            ...
            var mi = Tn(wn(Ar), In(), (function(t) {
                ...
                vi = Bn([In(), xn("base64")]),
                bi = Tn(wn(q.Buffer), vi, (function(t) {
            ...
            function ki(t) {
                return Tn(wi(t), xi, (function(e) {
                    return "error" in e ? e : yi(yi({}, e), {}, {
                        result: pn(e.result, t)
                    })
                }))
            }
            ...
            var $i = Mn({
                ...
                Ri = (Mn({
                    pubkey: mi,
                    account: Ci
                }), Tn(On([wn(q.Buffer), ji]), On([vi, ji]), (function(t) {
                ...
                ao = (Mn({
                    result: Ai(oo),
                    subscription: En()
                }), "js/".concat("0.0.0-development"), function() {
                    function t(e) {
                    ...
                    return W(t, [{
                        ...
                        value: function(e, n) {
                            ...
                            if (!n || !n.skipValidation)
                                for (var i = e.slice(0, 32), o = pr(i), a = 0; a < 32; a++)
                        ...
                        value: function(e) {
                            var n = pr(e),
                                r = new Uint8Array(64);
                            return r.set(e), r.set(n, 32), new t({
                                publicKey: n,
                                secretKey: r
                            })
                        }
            ...
            var uo = Object.freeze({
                ...
                RequestHeapFrame: {
                    index: 1,
                    layout: Qe.n_([Qe.u8("instruction"), Qe.Jq("bytes")])
                },
                SetComputeUnitLimit: {
                    index: 2,
                    layout: Qe.n_([Qe.u8("instruction"), Qe.Jq("units")])
                },
                SetComputeUnitPrice: {
                    index: 3,
                    layout: Qe.n_([Qe.u8("instruction"), li("microLamports")])
                }
            });
            (function() {
                function t() {
                ...
                return W(t, null, [{
                    ...
                    value: function(t) {
                        var e = ui(uo.SetComputeUnitPrice, {
            ...
            var lo = hr.getPublicKey,
                ...
                po = function() {
                    ...
                    return W(t, null, [{
                        ...
                        value: function(e) {
                            var n, r = e.ethAddress,
                                i = e.message,
                                o = e.signature,
                                a = e.recoveryId,
                                s = e.instructionIndex,
                                u = void 0 === s ? 0 : s;
                            ...
                            var c = 12 + n.length,
                                f = c + o.length + 1,
                                l = q.Buffer.alloc(ho.span + i.length);
                            return ho.encode({
                                numSignatures: 1,
                                signatureOffset: c,
            ...
            var go = new Ar("StakeConfig11111111111111111111111111111111"),
                yo = W((function t(e, n, r) {
            ...
            var mo = Object.freeze({
                    Initialize: {
                        index: 0,
                        layout: Qe.n_([Qe.Jq("instruction"), function() {
                ...
                vo = (Object.freeze({
                    ...
                    return W(t, null, [{
                        ...
                        value: function(t) {
                            var e = t.stakePubkey,
                                n = t.authorizedPubkey,
                                r = t.newAuthorizedPubkey,
                                i = t.stakeAuthorizationType,
                                o = t.custodianPubkey,
                                a = ui(mo.Authorize, {
                        ...
                        value: function(t) {
                            var e = t.stakePubkey,
                                ...
                                r = t.authoritySeed,
                                i = t.authorityOwner,
                                o = t.newAuthorizedPubkey,
                                a = t.stakeAuthorizationType,
                                s = t.custodianPubkey,
                        ...
                        value: function(t) {
                            var e = t.stakePubkey,
                                n = t.sourceStakePubKey,
                                r = t.authorizedPubkey,
                                i = ui(mo.Merge);
                            return (new Xr).add({
                                keys: [{
                                    pubkey: e,
            ...
            var bo = Object.freeze({
                ...
                wo = (Object.freeze({
                    ...
                    return W(t, null, [{
                        ...
                        key: "authorizeWithSeed",
                        value: function(t) {
                            var e = t.currentAuthorityDerivedKeyBasePubkey,
                                n = t.currentAuthorityDerivedKeyOwnerPubkey,
                                r = t.currentAuthorityDerivedKeySeed,
                                i = t.newAuthorizedPubkey,
                                o = t.voteAuthorizationType,
                                a = t.votePubkey,
                                s = ui(bo.AuthorizeWithSeed, {
                        ...
                        value: function(t) {
                            var e = t.votePubkey,
                                n = t.authorizedWithdrawerPubkey,
                                r = t.lamports,
                                i = t.toPubkey,
                                o = ui(bo.Withdraw, {
                                    lamports: r
            ...
            class qo extends T {
                ...
                async sendTransaction(t, e, n = {}) {
                    try {
                        ...
                        if (!i) throw new I;
                        let o;
                        if (h in Wo(this, Oo, "f").features)
                            if (i.features.includes(h)) o = h;
                            else {
            ...
            Eo = new WeakMap, Ao = new WeakMap, So = new WeakMap, Io = new WeakMap, Bo = new WeakMap, Mo = new WeakMap, Oo = new WeakMap, _o = new WeakMap, jo = new WeakMap, ko = new WeakSet, To = async function(t) {
                ...
                try {
                    ...
                    try {
                        return (await Wo(this, Oo, "f").features[P].signMessage({
                            account: e,
                            message: t
                        }))[0].signature
                    } catch (t) {
            ...
            const {
                Elm: Do
            } = r(652), Fo = r(468), Ho = "solana-connect-modal", Vo = "__sc__outer_modal", Jo = "__sc__elm_app", Zo = "__sc__ev_connect", Go = "__sc__ev_vis";
            class Yo {
                constructor(t) {
                    var e;
                    ...
                    const r = function() {
                        if (customElements.get(Ho)) throw Error("Ethereum Connect already instantiated!");
                    ...
                    const i = t => {
                        ...
                        o = t => {
                            ...
                            }(t) ? this.log("wallet not compatible:", t.name): i(new qo({
                                wallet: t
                            }))
                        };
        ...
        function M(t, e) {
            ...
            var r = B(t),
                ...
                o = u(r),
                a = i ? [o].concat(o.visualViewport || [], E(r) ? r : []) : r,
                s = e.concat(a);
        ...
        function dt(t, e) {
            ...
            var n = e,
                ...
                $ = function(t, e, n, r) {
                    var i = "clippingParents" === e ? function(t) {
                            var e = M(I(t)),
                                n = ["absolute", "fixed"].indexOf(k(t).position) >= 0 && f(t) ? T(t) : t;
                ...
                }(c(_) ? _ : _.contextElement || w(t.elements.popper), u, p, a),
            ...
            if (y === q && D) {
                ...
                Object.keys(K).forEach((function(t) {
                    var e = [j, P].indexOf(t) >= 0 ? 1 : -1,
                        n = [L, P].indexOf(t) >= 0 ? "y" : "x";
                    K[t] += F[n] * e
                }))
            }
            return K
                ...
                defaultModifiers: [{
                        ...
                        var e = t.state,
                            ...
                            a = D.reduce((function(t, n) {
                                return t[n] = function(t, e, n) {
                                    var r = Y(t),
                                        i = [C, L].indexOf(r) >= 0 ? -1 : 1,
                                        o = "function" == typeof n ? n(Object.assign({}, e, {
                                            placement: t
                                        })) : n,
                                        a = o[0],
                                        s = o[1];
                                    return a = a || 0, s = (s || 0) * i, [C, j].indexOf(r) >= 0 ? {
                                        x: s,
                                        y: a
                                    } : {
                                        x: a,
                    ...
                    fn: function(t) {
                        var e = t.state,
                            ...
                            I = e.rects.reference,
                            B = e.rects.popper,
                            M = "function" == typeof m ? m(Object.assign({}, e.rects, {
                                placement: e.placement
                            })) : m,
                            O = "number" == typeof M ? {
                                mainAxis: M,
                        ...
                        if (A) {
                            if (o) {
                                var R, U = "y" === k ? L : C,
                                    ...
                                    st = null != (R = null == _ ? void 0 : _[k]) ? R : 0,
                                    ut = q + it - st,
                            ...
                            if (s) {
                                var ft, lt = "x" === k ? L : C,
                                    ...
                                    vt = pt - v[ht],
                                    bt = -1 !== [L, C].indexOf(b),
                                    wt = null != (ft = null == _ ? void 0 : _[E]) ? ft : 0,
                                    xt = bt ? mt : pt - I[yt] - B[yt] - wt + O.altAxis,
                                    kt = bt ? pt + I[yt] + B[yt] - wt - O.altAxis : vt,
                                    Et = g && bt ? function(t, e, n) {
                                        var r = gt(t, e, n);
                                        return r > n ? n : r
        ...
        function Jt(t, e) {
            var n = Object.assign({}, e, {
                ...
                return (e ? Object.keys(Vt(Object.assign({}, Ft, {
                    plugins: e
                }))) : Ht).reduce((function(e, n) {
        ...
        function ie(t, e) {
            var n, r, i, o, a, s, u, c, f = Jt(t, Object.assign({}, Ft, Vt(Lt(e)))),
                l = !1,
                h = !1,
                d = !1,
                p = !1,
                g = [],
                y = Mt(V, f.interactiveDebounce),
                m = ee++,
                v = (c = f.plugins).filter((function(t, e) {
                ...
                b = {
                    ...
                    show: function() {
                        var t = b.state.isVisible,
                            ...
                            i = St(b.props.duration, 0, Ft.duration);
            ...
            function K(e, n, r) {
                void 0 === r && (r = !1), Ot(b.props.triggerTarget || t).forEach((function(t) {
                    t.addEventListener(e, n, r), g.push({
                        node: t,
                        eventType: e,
                        handler: n,
                        options: r
        ...
        const he = document.querySelector(".custom-generator__avatar canvas"),
            de = document.querySelectorAll(".choices__item"),
            pe = document.querySelectorAll(".btn_download"),
            ge = document.querySelector(".btn_random"),
            ye = 1024,
            me = 1024,
            ve = ["/pengs_assets/parts/background/common/Bg 4.png", "/pengs_assets/parts/background/rare/Bg 1.png", "/pengs_assets/parts/background/rare/Bg 2.png", "/pengs_assets/parts/background/rare/Bg 3.png"],
            be = ["/pengs_assets/parts/body/common/Original.png", "/pengs_assets/parts/body/rare/Green.png", "/pengs_assets/parts/body/rare/Grey blue.png", "/pengs_assets/parts/body/rare/Red.png", "/pengs_assets/parts/body/super rare/Robot.png" ,"/pengs_assets/parts/body/common/black.png","/pengs_assets/parts/body/common/blue.png","/pengs_assets/parts/body/common/cheetah.png","/pengs_assets/parts/body/common/ghostly.png","/pengs_assets/parts/body/common/tiger.png","/pengs_assets/parts/body/common/white.png","/pengs_assets/parts/body/common/cstm.png","/pengs_assets/parts/body/common/off.png"],
            we = ["#", "/pengs_assets/parts/clothes/common/Bip.png", "/pengs_assets/parts/clothes/common/Cape.png", "/pengs_assets/parts/clothes/common/Icy sweater.png", "/pengs_assets/parts/clothes/common/Naruto jacket.png", "/pengs_assets/parts/clothes/common/Ponco.png", "/pengs_assets/parts/clothes/common/Shirt.png", "/pengs_assets/parts/clothes/rare/Jacket.png", "/pengs_assets/parts/clothes/rare/Medal.png", "/pengs_assets/parts/clothes/rare/Tuxedo.png", "/pengs_assets/parts/clothes/super rare/Duck float.png", "/pengs_assets/parts/clothes/super rare/Wings.png","/pengs_assets/parts/clothes/common/astronaunt.png","/pengs_assets/parts/clothes/common/blacktee.png","/pengs_assets/parts/clothes/common/blazer.png","/pengs_assets/parts/clothes/common/goldjacket.png","/pengs_assets/parts/clothes/common/redshirt.png","/pengs_assets/parts/clothes/clothes/turtleneck..png"],
            xe = ["/pengs_assets/parts/eyes/common/Original.png", "/pengs_assets/parts/eyes/common/Big eyes.png", "/pengs_assets/parts/eyes/common/Sus.png", "/pengs_assets/parts/eyes/common/Weird.png", "/pengs_assets/parts/eyes/common/Xx.png", "/pengs_assets/parts/eyes/rare/Pixel.png", "/pengs_assets/parts/eyes/rare/Red eyes.png", "/pengs_assets/parts/eyes/rare/Warrior.png", "/pengs_assets/parts/eyes/super rare/Robot eyes.png","/pengs_assets/parts/eyes//crosseye.png","/pengs_assets/parts/eyes/common/love glasses.png","/pengs_assets/parts/eyes/common/sharingan.png","/pengs_assets/parts/eyes/common/love.png","/pengs_assets/parts/eyes/common/spectacles.png","/pengs_assets/parts/eyes/common/white glow.png","/pengs_assets/parts/eyes/common/sus eye2.png","/pengs_assets/parts/eyes/common/angry eye.png"],
            ke = ["#", "/pengs_assets/parts/head/common/Cap.png", "/pengs_assets/parts/head/common/Headband.png", "/pengs_assets/parts/head/common/Mafia.png", "/pengs_assets/parts/head/rare/Afro.png", "/pengs_assets/parts/head/rare/Arrow.png", "/pengs_assets/parts/head/rare/Egg.png", "/pengs_assets/parts/head/rare/Goggles.png", "/pengs_assets/parts/head/rare/Russian hat.png", "/pengs_assets/parts/head/super rare/Horns.png", "/pengs_assets/parts/head/super rare/Mohawk.png","/pengs_assets/parts/head/common/blue gradient.png","/pengs_assets/parts/head/common/pink gradient.png","/pengs_assets/parts/head/common/pink.png","/pengs_assets/parts/head/common/rainbow.png","/pengs_assets/parts/head/common/solana.png","/pengs_assets/parts/head/common/yellow gradient.png"],
            Ee = ["/pengs_assets/parts/mouth/common/Original.png", "/pengs_assets/parts/mouth/common/Rabbit teeth.png", "/pengs_assets/parts/mouth/common/Tounge.png", "/pengs_assets/parts/mouth/rare/Drool.png", "/pengs_assets/parts/mouth/rare/Fangs.png", "/pengs_assets/parts/mouth/rare/Jaws.png", "/pengs_assets/parts/mouth/rare/Smoke.png", "/pengs_assets/parts/mouth/super rare/Gold.png","/pengs_assets/parts/mouth/common/cigar.png","/pengs_assets/parts/mouth/common/gum.png","/pengs_assets/parts/mouth/common/lolipop.png","/pengs_assets/parts/mouth/common/pizza.png","/pengs_assets/parts/mouth/common/shout.png","/pengs_assets/parts/mouth/common/weed.png"],
            Ae = {
                background: "/pengs_assets/parts/background/common/Bg 4.png",
                body: "/pengs_assets/parts/body/common/Original.png",
                clothes: "#",
                eyes: "/pengs_assets/parts/eyes/common/Original.png",
                head: "#",
                mouth: "/pengs_assets/parts/mouth/common/Original.png"
            };
        async function Se(t, e) {
            return t.canvas.parentElement.classList.add("_loading"),
                function(t) {
        ...
        window.onload = async () => {
            ...
            await Se(t, Ae), ge && ge.addEventListener("click", (e => {
                ...
                r.forEach((e => {
                    ...
                    if (!i) return;
                    const o = i.includes("elite");
                    e.addEventListener("click", (a => (a.preventDefault(), a.stopPropagation(), r.forEach((t => t.classList.remove("selected"))), e.classList.add("selected"), Ae[n] = i, Se(t, Ae))($(".choices__overlay").fadeIn(300))))
                }))
